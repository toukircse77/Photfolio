      ...
      <div id="contact" className="container section">
        ...
        <div className="row contacts">
          ...
          <div className="contacts__social col-md-3 pt-4 pt-md-0">
            <ul>
              <li><a href="https://github.com/toukircse77" target="_blank"><i className="fa fa-github"></i> GitHub</a></li>
              <li><a href="https://www.linkedin.com/in/toukircse777/" target="_blank"><i className="fa fa-linkedin-square"></i> Linkedin</a></li>
              <li><a href="https://www.facebook.com/profile.php?id=100029985392696" target="_blank"><i className="fa fa-facebook-square"></i> Facebook</a></li>
              <li><a href="#" target="_blank"><i className="fab fa-instagram"></i> Instagram</a></li>
            </ul>
          </div>
          <div className="footer ps-md-5 ms-md-5 mt-5">
            <p>@copy; 2022 MD.TOUKIR AHMED. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>
